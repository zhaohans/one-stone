...
const Messages = () => {
  ...
  const messages = [
    {
      ...
      from: "John Smith",
      preview:
        "Could you please provide an update on my portfolio performance for Q4?",
    ...
    },
    {
      ...
      from: "Sarah Chen",
      preview:
        "There seems to be a delay in the settlement for trade TRD-12345...",
  ...
  const tasks = [
    ...
    },
    {
      ...
      description:
        "Update compliance procedures documentation for new regulations",
      assignee: "David Lee",
      dueDate: "2024-01-10",
      status: "overdue",
      priority: "high",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage communications and workflow tasks
          </p>
        </div>
