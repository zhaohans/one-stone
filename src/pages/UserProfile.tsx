          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("officeNo", e.target.value)
                      }
                    />
                  </div>
                      ...
                      <Input
                        ...
                        value={
                          showEmail
                            ...
                            : maskEmail(profileData.workEmail)
                        }
                        onChange={(e) =>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        value={
                          showPhone
                            ? profileData.personalPhone
                            : maskPhone(profileData.personalPhone)
                        }
                        onChange={(e) =>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your role and department within One Stone Capital
                </CardDescription>
              </CardHeader>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="relationship-management">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="client-services">
                          Client Services
                        </SelectItem>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Changing login email requires email verification
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  ...
                  <div>
                    <Label htmlFor="loginDuration">
                      Login Duration (hours)
                    </Label>
                    <div className="flex gap-2">
                      <Select
                        value={profileData.loginDuration}
                        onValueChange={(value) =>
                          handleInputChange("loginDuration", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Session auto-expires after selected time for
                            security
                          </p>
                        </TooltipContent>
                      </Tooltip>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-gray-600">
                    <strong>Last Login:</strong> Today at 2:30 PM from Singapore
                    (IP: 203.116.43.77)
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("inAppNotifications", checked)
                      }
                    />
                  </div>
