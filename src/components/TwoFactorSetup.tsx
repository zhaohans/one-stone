...
const TwoFactorSetup = ({ open, onOpenChange, isEnabled, onToggle }: TwoFactorSetupProps) => {
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="disableCode">Enter verification code to disable 2FA</Label>
            <Input
              id="disableCode"
          ...
          <div className="flex gap-2">
            ...
            <Button variant="destructive" onClick={handleVerify} className="flex-1">
              Disable 2FA
            </Button>
          </div>
        </div>
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 rounded-lg p-8 text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">QR Code for OSC Account</p>
            </div>
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <p className="text-sm text-yellow-700 mb-3">
                Store these codes in a secure location. You can use them if you lose access to your authenticator app.
              </p>
              <div className="grid grid-cols-1 gap-1 font-mono text-sm">
                {backupCodes.map((code, index) => (
                  <span key={index} className="bg-white px-2 py-1 rounded border">
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {isEnabled ? 'Manage Two-Factor Authentication' : 'Setup Two-Factor Authentication'}
          </DialogTitle>
          <DialogDescription>
            {isEnabled 
