...
export class AIInsightsService {
  ...
  static async getChatResponse(message: string, context?: Record<string, any>): Promise<{
    success: boolean;
    response?: string;
    error?: string;
  }> {
      ...
      baseInsights.push(
        {
          ...
          description: 'Your portfolio has 32% concentration in technology stocks, which may increase volatility during tech sector downturns.',
          confidence: 0.85,
          priority: 'medium',
          actionable: true,
        ...
        },
        {
          ...
          description: 'Consider adding healthcare and consumer staples to improve portfolio balance and reduce correlation.',
          confidence: 0.78,
          priority: 'low',
          actionable: true,
      ...
      baseInsights.push(
        {
          ...
          description: 'Portfolio beta is 1.24, indicating higher volatility than market average. Consider defensive positions.',
          confidence: 0.92,
          priority: 'high',
          actionable: true,
      ...
      baseInsights.push(
        {
          ...
          description: 'Rising interest rates may negatively impact growth stocks in your portfolio over the next quarter.',
          confidence: 0.72,
          priority: 'medium',
          actionable: true,
  ...
  private static generateChatResponse(message: string, context?: Record<string, any>): string {
