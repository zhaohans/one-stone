...
const GOOGLE_CLIENT_ID = '309045407817-aoai5g4ure33bueen40k2l2nq8n73r1m.apps.googleusercontent.com';
...
export async function getGoogleCredentials() {
  const credentials = {
    ...
    tokens: {
      ...
      scope: process.env.GOOGLE_SCOPE || 'https://www.googleapis.com/auth/drive.file',
      token_type: 'Bearer',
